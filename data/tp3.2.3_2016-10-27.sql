...
# Database: tp3.2.3
# Generation Time: 2016-10-27 09:27:50 +0000
# ************************************************************
...
INSERT INTO `tp_access` (`role_id`, `node_id`, `level`, `module`)
VALUES
	(2,4,2,NULL),
	(1,5,3,NULL),
	(1,3,2,NULL);
...
VALUES
	...
	(4,1,'henry','henry','027e4180beedb29744413a7ea6b84a42','lin_hailing@sina.com',1,'18721186620',1,0,0,0.00,0,'1','2016-10-26 17:34:14','2016-10-26 17:34:14',0);
...
INSERT INTO `tp_node` (`id`, `name`, `title`, `status`, `remark`, `sort`, `pid`, `level`)
VALUES
...
INSERT INTO `tp_role_user` (`role_id`, `user_id`)
VALUES
	(1,'4'),
	(2,'4');
